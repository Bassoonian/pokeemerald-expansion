...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_TURTWIG] =
    {
        ...
        .height = 4,
        .weight = 102,
        .description = COMPOUND_STRING("The shell on its back is made of soil.  On a very healthy Turtwig, the shell  should feel moist. The leaf on its head wilts if it is thirsty."),
        .pokemonScale = 491,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GROTLE] =
    {
        ...
        .height = 11,
        .weight = 970,
        .description = COMPOUND_STRING("A Grotle that lives in the forest is said to have its own secret springwater well.  It carries fellow Pokémon there on  its back."),
        .pokemonScale = 320,
        .pokemonOffset = 9,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TORTERRA] =
    {
        ...
        .height = 22,
        .weight = 3100,
        .description = COMPOUND_STRING("Some Pokémon are born on a Torterra's back and spend their entire life there. Ancient people imagined that beneath  the ground, a gigantic Torterra dwelled."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 348,
        .trainerOffset = 6,
    ...
    [SPECIES_CHIMCHAR] =
    {
        ...
        .height = 5,
        .weight = 62,
        .description = COMPOUND_STRING("Its fiery rear end is fueled by gas made in its belly. Before going to sleep, Chimchar extinguish the flame on their tails to prevent fires."),
        .pokemonScale = 432,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MONFERNO] =
    {
        ...
        .height = 9,
        .weight = 220,
        .description = COMPOUND_STRING("It carefully controls the intensity of the flame on its tail, so as to keep its foes at an adequate distance. Its fiery tail is but one weapon."),
        .pokemonScale = 338,
        .pokemonOffset = 9,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_INFERNAPE] =
    {
        ...
        .height = 12,
        .weight = 550,
        .description = COMPOUND_STRING("Its crown of fire is indicative of its fiery nature. It uses a special kind of martial arts involving all of its limbs to take on any opponent."),
        .pokemonScale = 282,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PIPLUP] =
    {
        ...
        .height = 4,
        .weight = 52,
        .description = COMPOUND_STRING("A poor walker, it often falls down. However, its strong pride makes it puff up its chest without a care. It's difficult to bond with since it won't listen to its Trainer."),
        .pokemonScale = 491,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PRINPLUP] =
    {
        ...
        .height = 8,
        .weight = 230,
        .description = COMPOUND_STRING("Because every Prinplup considers itself to be the most important, they can never form a group. It searches for prey in icy seas."),
        .pokemonScale = 366,
        .pokemonOffset = 10,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_EMPOLEON] =
    {
        ...
        .height = 17,
        .weight = 845,
        .description = COMPOUND_STRING("The three horns that extend from its beak attest to its power. It avoids unnecessary disputes, but it will decimate anything that threatens its pride."),
        .pokemonScale = 259,
        .pokemonOffset = 0,
        .trainerScale = 290,
        .trainerOffset = 1,
    ...
    [SPECIES_STARLY] =
    {
        ...
        .height = 3,
        .weight = 20,
        .description = COMPOUND_STRING("They flock around mountains and fields, chasing after bug Pokémon. However, they bicker if the group grows too big. Their singing is noisy and annoying."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_STARAVIA] =
    {
        ...
        .height = 6,
        .weight = 155,
        .description = COMPOUND_STRING("Recognizing their own weakness, they maintain huge flocks. Fierce scuffles break out between various flocks. When alone, a Staravia cries noisily."),
        .pokemonScale = 422,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_STARAPTOR] =
    {
        ...
        .height = 12,
        .weight = 249,
        .description = COMPOUND_STRING("When Staravia evolve into Staraptor, they leave the flock to live alone. It has a savage nature. It will courageously challenge foes that are much larger."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BIDOOF] =
    {
        ...
        .height = 5,
        .weight = 200,
        .description = COMPOUND_STRING("A comparison revealed that Bidoof's front teeth grow at the same rate as Rattata's. It constantly gnaws on logs and rocks to whittle down its front teeth."),
        .pokemonScale = 432,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BIBAREL] =
    {
        ...
        .height = 10,
        .weight = 315,
        .description = COMPOUND_STRING("It makes its nest by damming streams with bark and mud. A river dammed by Bibarel will never overflow its banks, which is appreciated by people nearby."),
        .pokemonScale = 305,
        .pokemonOffset = 8,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_KRICKETOT] =
    {
        ...
        .height = 3,
        .weight = 22,
        .description = COMPOUND_STRING("It shakes its head back to front, causing its antennae to hit each other and sound like a xylophone. These sounds are fall hallmarks."),
        .pokemonScale = 530,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_KRICKETUNE] =
    {
        ...
        .height = 10,
        .weight = 255,
        .description = COMPOUND_STRING("It signals its emotions with its melodies. There is a village that hosts a contest based on the amazingly variable cries of this Pokémon."),
        .pokemonScale = 305,
        .pokemonOffset = 8,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_SHINX] =
    {
        ...
        .height = 5,
        .weight = 95,
        .description = COMPOUND_STRING("It rapidly contracts and relaxes its muscles to generate electricity. Its body shines if endangered. It flees while the foe is momentarily blinded."),
        .pokemonScale = 432,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LUXIO] =
    {
        ...
        .height = 9,
        .weight = 305,
        .description = COMPOUND_STRING("Strong electricity courses through the tips of its sharp claws. A light scratch has enough amperage to cause fainting in foes."),
        .pokemonScale = 338,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LUXRAY] =
    {
        ...
        .height = 14,
        .weight = 420,
        .description = COMPOUND_STRING("It has eyes which can see through anything. Luxray's ability to see through objects comes in handy when it's scouting for danger."),
        .pokemonScale = 265,
        .pokemonOffset = 2,
        .trainerScale = 262,
        .trainerOffset = 0,
    ...
    [SPECIES_CRANIDOS] =
    {
        ...
        .height = 9,
        .weight = 315,
        .description = COMPOUND_STRING("A lifelong jungle dweller from 100 million years ago, its skull is as hard as iron.  It would snap obstructing trees with headbutts."),
        .pokemonScale = 338,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_RAMPARDOS] =
    {
        ...
        .height = 16,
        .weight = 1025,
        .description = COMPOUND_STRING("The result of repeated headbutts is a skull grown thick and hard. However, its brain has shrunk in size compared with Cranidos's."),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 296,
        .trainerOffset = 1,
    ...
    [SPECIES_SHIELDON] =
    {
        ...
        .height = 5,
        .weight = 570,
        .description = COMPOUND_STRING("This Pokémon lived in primeval jungles. Few enemies would have been willing to square off against its heavily armored face, so it's thought."),
        .pokemonScale = 432,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BASTIODON] =
    {
        ...
        .height = 13,
        .weight = 1495,
        .description = COMPOUND_STRING("Their rock-hard faces serve to protect them from any frontral attacks. When attacked, they form a wall. They shielded their young in that way."),
        .pokemonScale = 272,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BURMY_PLANT] =
    {
        ...
        .height = 2,
        .weight = 34,
        .description = COMPOUND_STRING("If its cloak is even slightly damaged, it will immediately repair it with whatever is near at hand. The Pokémon within the cloak is scrawny and vulnerable to the cold."),
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BURMY_SANDY] =
    {
        ...
        .height = 2,
        .weight = 34,
        .description = COMPOUND_STRING("It weaves a cloak together with sand, mud, and silk it spits out. This earthen cloak is ruined by wind and rain, so the Pokémon hides away in caves and other such places."),
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BURMY_TRASH] =
    {
        ...
        .height = 2,
        .weight = 34,
        .description = COMPOUND_STRING("When confronted by a lack of other materials, Burmy will create its cloak using dust and refuse. The cloak seems to be more comfortable than one would think."),
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WORMADAM_PLANT] =
    {
        ...
        .height = 5,
        .weight = 65,
        .description = COMPOUND_STRING("Its appearance changes depending on where Burmy evolved. The materials on hand become a part of its body. The cloak is never shed."),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WORMADAM_SANDY] =
    {
        ...
        .height = 5,
        .weight = 65,
        .description = COMPOUND_STRING("Its earthen skin is reasonably hard, it has no problem repelling a Starly's pecking. It is said that a Wormadam that evolves on a cold day will have a thicker cloak."),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WORMADAM_TRASH] =
    {
        ...
        .height = 5,
        .weight = 65,
        .description = COMPOUND_STRING("Its body, composed of refuse, blends in to the scenery enough to be inconspicuous. This seems to be the perfect way for it to evade the detection of predators."),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_COMBEE] =
    {
        ...
        .height = 3,
        .weight = 55,
        .description = COMPOUND_STRING("A Pokémon formed by three others. It constantly gathers honey from flowers to please Vespiquen. At night, they cluster to form a beehive and sleep."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_VESPIQUEN] =
    {
        ...
        .height = 12,
        .weight = 385,
        .description = COMPOUND_STRING("It houses its colony in cells in its body and releases various pheromones to make those grubs do its bidding. There is only one in a colony."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PACHIRISU] =
    {
        ...
        .height = 4,
        .weight = 39,
        .description = COMPOUND_STRING("A pair may be seen rubbing their cheek pouches together in an effort to share stored electricity. It stores them with berries in tree holes."),
        .pokemonScale = 491,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BUIZEL] =
    {
        ...
        .height = 7,
        .weight = 295,
        .description = COMPOUND_STRING("It inflates its flotation sac, keeping its face above water in order to watch for prey movement. It swims by rotating its two tails like a screw."),
        .pokemonScale = 365,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FLOATZEL] =
    {
        ...
        .height = 11,
        .weight = 335,
        .description = COMPOUND_STRING("Its flotation sac developed as a result of pursuing aquatic prey. It can double as a rubber raft. It assists in the rescues of drowning people."),
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CHERUBI] =
    {
        ...
        .height = 4,
        .weight = 33,
        .description = COMPOUND_STRING("The small ball holds the nutrients needed for evolution. Apparently, it is also very sweet and tasty. Pokémon like Starly and Taillow try to peck it off."),
        .pokemonScale = 491,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CHERRIM_OVERCAST] =
    {
        ...
        .height = 5,
        .weight = 93,
        .description = COMPOUND_STRING("It's motionless, save for the occasional quiver. A rich array of Pokémon can be found gathered around it, drawn by the scent exuded from Cherrim's folded petals."),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CHERRIM_SUNSHINE] =
    {
        ...
        .height = 5,
        .weight = 93,
        .description = COMPOUND_STRING("Cherrim takes this form on sunny days. Its faint scent entices bug Pokémon to it. It immediately closes its petals and becomes immobile once the sun hides."),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SHELLOS_WEST] =
    {
        ...
        .height = 3,
        .weight = 63,
        .description = COMPOUND_STRING("It oozes a purple fluid to deter enemies. While harmless, the fluid is awfully sticky. Apparently, there are more West Sea Shellos now than there were in the past."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SHELLOS_EAST] =
    {
        ...
        .height = 3,
        .weight = 63,
        .description = COMPOUND_STRING("It's capable of spending a limited amount of time on land until their skin dries out. One theory suggests that living in cold seas causes Shellos to take on this form."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GASTRODON_WEST] =
    {
        ...
        .height = 9,
        .weight = 299,
        .description = COMPOUND_STRING("It appears on shallow-water beaches to eat sand for nourishment. Should one Gastrodon encounter another of a different color, a fierce battle will ensue."),
        .pokemonScale = 338,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GASTRODON_EAST] =
    {
        ...
        .height = 9,
        .weight = 299,
        .description = COMPOUND_STRING("Found more often on land than in the sea. They normally live in rocky seashores, but when cloudy or rainy, they can sometimes be found on mountains, far from the sea."),
        .pokemonScale = 338,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DRIFLOON] =
    {
        ...
        .height = 4,
        .weight = 12,
        .description = COMPOUND_STRING("Because of the way it floats aimlessly, an old folktale calls it a “Signpost for Wandering Spirits.” Children holding them sometimes vanish."),
        .pokemonScale = 491,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DRIFBLIM] =
    {
        ...
        .height = 12,
        .weight = 150,
        .description = COMPOUND_STRING("Even while under careful observation, large flocks of Drifblim flying at dusk will inexplicably disappear from view. No one knows where they go."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BUNEARY] =
    {
        ...
        .height = 4,
        .weight = 55,
        .description = COMPOUND_STRING("You can tell how it feels by the way it rolls its ears. When it's scared, both ears are rolled up. When it senses danger, it perks them up."),
        .pokemonScale = 491,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LOPUNNY] =
    {
        ...
        .height = 12,
        .weight = 333,
        .description = COMPOUND_STRING("An extremely cautious Pokémon. It is very conscious of its looks and never fails to groom its ears. It runs with sprightly jumps."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LOPUNNY_MEGA] =
    {
        ...
        .height = 13,
        .weight = 283,
        .description = COMPOUND_STRING("Mega Evolution awakens its combative instincts. It has shed any fur that got in the way of its attacks. crescent."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GLAMEOW] =
    {
        ...
        .height = 5,
        .weight = 39,
        .description = COMPOUND_STRING("It is a very fickle Pokémon, which is  very popular among some. It claws its Trainer's nose if it isn't fed and purrs when affectionate."),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PURUGLY] =
    {
        ...
        .height = 10,
        .weight = 438,
        .description = COMPOUND_STRING("It is a brazen brute that barges its way into another Pokémon's nest and claims it as its own. It binds its body with its tails to make itself look bigger."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_STUNKY] =
    {
        ...
        .height = 4,
        .weight = 192,
        .description = COMPOUND_STRING("It protects itself by spraying a nose-curling, stinky fluid from its rear to repel attackers. The stench lingers for 24 hours."),
        .pokemonScale = 491,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SKUNTANK] =
    {
        ...
        .height = 10,
        .weight = 380,
        .description = COMPOUND_STRING("It attacks by spraying a horribly smelly fluid from the tip of its tail. The fluid smells worse the longer it is allowed to fester."),
        .pokemonScale = 305,
        .pokemonOffset = 9,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_BRONZOR] =
    {
        ...
        .height = 5,
        .weight = 605,
        .description = COMPOUND_STRING("Implements shaped like it were discovered in ancient tombs. There are researchers who believe this Pokémon reflected like a mirror in the distant past."),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BRONZONG] =
    {
        ...
        .height = 13,
        .weight = 1870,
        .description = COMPOUND_STRING("In ages past, this Pokémon was revered as a bringer of rain. One caused a news stir when it was dug up at a construction site after a 2000-year sleep."),
        .pokemonScale = 272,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CHATOT] =
    {
        ...
        .height = 5,
        .weight = 19,
        .description = COMPOUND_STRING("It mimics the cries of other Pokémon to trick them into thinking it's one of them. This way they won't attack it. It can also learn and speak human words."),
        .pokemonScale = 432,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SPIRITOMB] =
    {
        ...
        .height = 10,
        .weight = 1080,
        .description = COMPOUND_STRING("A Pokémon that was formed by 108 spirits. Its constant mischief and misdeeds resulted in it being bound to an Odd Keystone by a mysterious spell."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_GIBLE] =
    {
        ...
        .height = 7,
        .weight = 205,
        .description = COMPOUND_STRING("It nests in horizontal holes warmed by geothermal heat. Foes who stray too close can expect to be pounced on and bitten."),
        .pokemonScale = 365,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GABITE] =
    {
        ...
        .height = 14,
        .weight = 560,
        .description = COMPOUND_STRING("Shiny objects are its passion. It can be found in its cave, scarcely moving, its gaze fixed on the jewels it's amassed or Carbink it has caught."),
        .pokemonScale = 265,
        .pokemonOffset = 2,
        .trainerScale = 262,
        .trainerOffset = 0,
    ...
    [SPECIES_GARCHOMP] =
    {
        ...
        .height = 19,
        .weight = 950,
        .description = COMPOUND_STRING("When it folds up its body and extends its wings, it looks like a jet plane. It is covered in fine scales that reduce drag, enabling it to fly at high speeds."),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 326,
        .trainerOffset = 4,
    ...
    [SPECIES_GARCHOMP_MEGA] =
    {
        ...
        .height = 19,
        .weight = 950,
        .description = COMPOUND_STRING("Excess energy melted its arms and wings into giant scythes, sending it mad with rage. It swings its scythes wildly and slices the ground to pieces."),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 326,
        .trainerOffset = 4,
    ...
    [SPECIES_RIOLU] =
    {
        ...
        .height = 7,
        .weight = 202,
        .description = COMPOUND_STRING("It can discern the physical and emotional states of people, Pokémon, and other natural things from the shape of their aura waves."),
        .pokemonScale = 365,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LUCARIO] =
    {
        ...
        .height = 12,
        .weight = 540,
        .description = COMPOUND_STRING("It understands human speech. It is said that no foe can remain invisible to Lucario, since it can detect Auras. Even foes it could not otherwise see."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LUCARIO_MEGA] =
    {
        ...
        .height = 13,
        .weight = 575,
        .description = COMPOUND_STRING("It readies itself to face its enemies by focusing its mental energies. Its fighting style can be summed up in a single word: heartless."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HIPPOPOTAS] =
    {
        ...
        .height = 8,
        .weight = 495,
        .description = COMPOUND_STRING("Hippopotas shuts its nostrils tight when travelling through sand. Instead of perspiration, it expels grains of sand from its body."),
        .pokemonScale = 366,
        .pokemonOffset = 11,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_HIPPOWDON] =
    {
        ...
        .height = 20,
        .weight = 3000,
        .description = COMPOUND_STRING("It is surprisingly quick to anger. It brandishes its gaping mouth in a display of fearsome strength and raises vast quantities of sand while attacking."),
        .pokemonScale = 261,
        .pokemonOffset = 2,
        .trainerScale = 334,
        .trainerOffset = 4,
    ...
    [SPECIES_SKORUPI] =
    {
        ...
        .height = 8,
        .weight = 120,
        .description = COMPOUND_STRING("It grips prey with its tail claws and injects poison. It tenaciously hangs on until the poison takes. It can survive a year without food."),
        .pokemonScale = 366,
        .pokemonOffset = 12,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_DRAPION] =
    {
        ...
        .height = 13,
        .weight = 615,
        .description = COMPOUND_STRING("Possessing a sturdy build, it takes pride in its strength. It has the power in its clawed arms to make scrap out of a car."),
        .pokemonScale = 272,
        .pokemonOffset = 5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CROAGUNK] =
    {
        ...
        .height = 7,
        .weight = 230,
        .description = COMPOUND_STRING("Croagunk rarely fights fairly. Inflating its poison sacs, it fills the area with an odd sound and hits flinching opponents with a poison jab."),
        .pokemonScale = 365,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TOXICROAK] =
    {
        ...
        .height = 13,
        .weight = 444,
        .description = COMPOUND_STRING("Swaying and dodging the attacks of its foes, it weaves its flexible body in close, then lunges out with its poisonous claws."),
        .pokemonScale = 272,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CARNIVINE] =
    {
        ...
        .height = 14,
        .weight = 270,
        .description = COMPOUND_STRING("Hanging from branches using its tentacles, it looks like a plant. It attracts prey with its sweet-smelling saliva, then chomps down."),
        .pokemonScale = 265,
        .pokemonOffset = 2,
        .trainerScale = 262,
        .trainerOffset = 0,
    ...
    [SPECIES_FINNEON] =
    {
        ...
        .height = 4,
        .weight = 70,
        .description = COMPOUND_STRING("Its double tail fins propel its energetic jumps. When it breaks the surface of the sea, Wingull swoop down to grab it on the fly."),
        .pokemonScale = 491,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LUMINEON] =
    {
        ...
        .height = 12,
        .weight = 240,
        .description = COMPOUND_STRING("Lumineon swimming in the darkness of the deep sea look like stars shining in the night sky. It competes for food with Lanturn."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SNOVER] =
    {
        ...
        .height = 10,
        .weight = 505,
        .description = COMPOUND_STRING("During cold seasons, it migrates to the mountain's lower reaches. Seemingly curious about people, they gather around footsteps they find on snowy mountains."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_ABOMASNOW] =
    {
        ...
        .height = 22,
        .weight = 1355,
        .description = COMPOUND_STRING("It lives a quiet life on mountains that are perpetually covered in snow. It hides itself by whipping up blizzards. It is also known as “The Ice Monster.”"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 348,
        .trainerOffset = 6,
    ...
    [SPECIES_ABOMASNOW_MEGA] =
    {
        ...
        .height = 27,
        .weight = 1850,
        .description = COMPOUND_STRING("The sprouts on Abomasnow's back grow into great shafts of ice when it Mega Evolves. Dislikes associating with others and chooses to live quietly deep in mountains."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 348,
        .trainerOffset = 6,
    ...
    [SPECIES_ROTOM] =
    {
        ...
        .height = 3,
        .weight = 3,
        .description = COMPOUND_STRING("Its body is composed of plasma and loves to surprise others. One boy's invention led to the development of many machines that can use of Rotom's unique capabilities."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ROTOM_HEAT] =
    {
        ...
        .height = 3,
        .weight = 3,
        .description = COMPOUND_STRING("If the convection microwave oven is not working properly, then the Rotom inhabiting it will become lethargic. It makes mischief by turning up the heat."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ROTOM_WASH] =
    {
        ...
        .height = 3,
        .weight = 3,
        .description = COMPOUND_STRING("It enjoys coming up with water-based pranks. The model of washing machine that Rotom can inspirit has been discontinued, so they are now traded at high prices."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ROTOM_FROST] =
    {
        ...
        .height = 3,
        .weight = 3,
        .description = COMPOUND_STRING("In this form, Rotom likes to play freezing cold pranks. You may find it's turned the bath you just filled to solid ice! It battles by spewing cold air."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ROTOM_FAN] =
    {
        ...
        .height = 3,
        .weight = 3,
        .description = COMPOUND_STRING("The first appliance developed that Rotom coud inspirit was the electric fan. It uses its power over wind in its pranks, happily blowing any important documents it finds."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ROTOM_MOW] =
    {
        ...
        .height = 3,
        .weight = 3,
        .description = COMPOUND_STRING("The lawn mower is an appliance that led to the development of the Rotom Dex. It will mow down grass and flowers, then swagger around with pride at its accomplishments."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_UXIE] =
    {
        ...
        .height = 3,
        .weight = 3,
        .description = COMPOUND_STRING("Known as ”The Being of Knowledge,” according to some sources, this Pokémon provided people with the intelligence necessary to solve various problems."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MESPRIT] =
    {
        ...
        .height = 3,
        .weight = 3,
        .description = COMPOUND_STRING("Although it slumbers at the bottom of a lake, its spirit is said to leave its body and flitter on the water surface. It taught humans of sorrow, pain, and joy."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_AZELF] =
    {
        ...
        .height = 3,
        .weight = 3,
        .description = COMPOUND_STRING("This Pokémon is said to have endowed humans with the determination needed to do things. It is thought that Uxie, Mesprit and Azelf all came from the same egg."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DIALGA] =
    {
        ...
        .height = 54,
        .weight = 6830,
        .description = COMPOUND_STRING("A Pokémon spoken of in legend. It completely controls the flow of time. It uses its power to travel at will through the past and future."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 721,
        .trainerOffset = 19,
    ...
    [SPECIES_DIALGA_ORIGIN] =
    {
        ...
        .height = 70,
        .weight = 8500,
        .description = COMPOUND_STRING("Radiant light caused Dialga to take on a form bearing a striking resemblance to the creator Pokémon. It wields such a colossal strength that this might be its true form."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 721,
        .trainerOffset = 19,
    ...
    [SPECIES_PALKIA] =
    {
        ...
        .height = 42,
        .weight = 3360,
        .description = COMPOUND_STRING("Palkia has the ability to distort space. Its total control over the boundaries of space enable it to transport itself to faraway places and other dimensions."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 650,
        .trainerOffset = 16,
    ...
    [SPECIES_PALKIA_ORIGIN] =
    {
        ...
        .height = 63,
        .weight = 6600,
        .description = COMPOUND_STRING("It soars across the sky in a form that resembles the creator of all things. Perhaps this imitation of appearance is a strategy for gaining Arceus's powers."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 650,
        .trainerOffset = 16,
    ...
    [SPECIES_HEATRAN] =
    {
        ...
        .height = 17,
        .weight = 4300,
        .description = COMPOUND_STRING("Boiling blood, like magma, circulates through its body. It dwells in volcanic caves, using its cross-shaped feet to crawl on ceilings and walls."),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 290,
        .trainerOffset = 1,
    ...
    [SPECIES_REGIGIGAS] =
    {
        ...
        .height = 37,
        .weight = 4200,
        .description = COMPOUND_STRING("There is an enduring legend that states this Pokémon shaped Regirock, Regice, and Registeel out of clay, ice, and magma."),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 610,
        .trainerOffset = 17,
    ...
    [SPECIES_GIRATINA_ALTERED] =
    {
        ...
        .height = 45,
        .weight = 7500,
        .description = COMPOUND_STRING("This Pokémon is said to live in a world on the reverse side of ours, where common knowledge is distorted and strange. It was banished for its violence."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 614,
        .trainerOffset = 13,
    ...
    [SPECIES_GIRATINA_ORIGIN] =
    {
        ...
        .height = 69,
        .weight = 6500,
        .description = COMPOUND_STRING("Giratina loses its legs upon changing into this form. It's believed it hails from a world where the heavens and the earth are as one."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 614,
        .trainerOffset = 13,
    ...
    [SPECIES_CRESSELIA] =
    {
        ...
        .height = 15,
        .weight = 856,
        .description = COMPOUND_STRING("Those who sleep holding one of Cresselia's feathers are assured of joyful dreams. It is said to represent the crescent moon."),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [SPECIES_PHIONE] =
    {
        ...
        .height = 4,
        .weight = 31,
        .description = COMPOUND_STRING("When the water warms, they inflate the flotation sac on their heads and drift languidly on the sea in packs. It always returns to where it was born."),
        .pokemonScale = 491,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MANAPHY] =
    {
        ...
        .height = 3,
        .weight = 14,
        .description = COMPOUND_STRING("Water makes up 80% of its body. It starts its life with a wondrous power that permits it to bond with any kind of Pokémon."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DARKRAI] =
    {
        ...
        .height = 15,
        .weight = 505,
        .description = COMPOUND_STRING("It chases people and Pokémon from its territory by causing them to experience deep, nightmarish slumbers. However, it means no harm."),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [SPECIES_SHAYMIN_LAND] =
    {
        ...
        .height = 2,
        .weight = 21,
        .description = COMPOUND_STRING("The flowers all over its body bloom if it is lovingly hugged and senses gratitude. It dissolves toxins in the air to transform ruined land into a lush field of flowers."),
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SHAYMIN_SKY] =
    {
        ...
        .height = 4,
        .weight = 52,
        .description = COMPOUND_STRING("Upon taking in the scent of a particular rare flower, Shaymin is enveloped in light and its tiny body transforms, confering the power of flight upon it."),
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,

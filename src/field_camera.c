...
{
    DrawWholeMapViewInternal(SAVEBLOCK_POS.x, SAVEBLOCK_POS.y, gMapHeader.mapLayout);
...
static void RedrawMapSliceNorth(struct FieldCameraOffset *cameraOffset, const struct MapLayout *mapLayout)
{
    ...
    for (i = 0; i < 32; i += 2)
    {
        ...
        if (temp >= 32)
            temp -= 32;
        DrawMetatileAt(mapLayout, r7 + temp, SAVEBLOCK_POS.x + i / 2, SAVEBLOCK_POS.y + 14);
    }
}
...
static void RedrawMapSliceSouth(struct FieldCameraOffset *cameraOffset, const struct MapLayout *mapLayout)
{
    ...
    for (i = 0; i < 32; i += 2)
    {
        ...
        if (temp >= 32)
            temp -= 32;
        DrawMetatileAt(mapLayout, r7 + temp, SAVEBLOCK_POS.x + i / 2, SAVEBLOCK_POS.y);
    }
}
...
static void RedrawMapSliceEast(struct FieldCameraOffset *cameraOffset, const struct MapLayout *mapLayout)
{
    ...
    for (i = 0; i < 32; i += 2)
    {
        ...
        if (temp >= 32)
            temp -= 32;
        DrawMetatileAt(mapLayout, temp * 32 + r6, SAVEBLOCK_POS.x, SAVEBLOCK_POS.y + i / 2);
    }
}
...
static void RedrawMapSliceWest(struct FieldCameraOffset *cameraOffset, const struct MapLayout *mapLayout)
{
    ...
    for (i = 0; i < 32; i += 2)
    {
        ...
        if (temp >= 32)
            temp -= 32;
        DrawMetatileAt(mapLayout, temp * 32 + r5, SAVEBLOCK_POS.x + 14, SAVEBLOCK_POS.y + i / 2);
    }
}
